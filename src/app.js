...
app.use(cookieParser()); //this cookies is used only by server and int client requests we store the cookies
//import routes
...
//http://localhost:8000/api/v1/users/register   //example of routes
